...
return {
  ...
  -- Treesitter
  {
    ...
    opts = {
      highlight = {
        enable = true,
        -- Ensure maximum highlighting quality for large files
        disable = {}, -- Don't disable highlighting for any filetypes (previously this might have been a function that disabled large files)
        additional_vim_regex_highlighting = false, -- Use Treesitter for all highlighting instead of falling back to regex
      },
      indent = {
        enable = true,
        disable = {}, -- Don't disable indentation for any filetypes
      },
      ensure_installed = {
        ...
        "php",
        "lua",
        -- Additional for Prisma (Prisma schema support)
        "prisma",
        -- Web essentials
        "html",
        "css",
        ...
        "markdown",
        "markdown_inline",
        -- For Node.js and general scripting
        "bash",
        "regex",
        "vim",
        "vimdoc",
        ...
        "gitcommit",
        "gitignore",
        -- Optional but useful for React/Next.js
        "graphql", -- Useful for Prisma if needed
      },
      ...
      -- Optional: Add textobjects for better navigation and selection
      textobjects = {
        select = {
          enable = true,
          lookahead = true,
      ...
      -- Optional: Playground for debugging Treesitter queries
      playground = {
        enable = true,
        disable = {},
        updatetime = 25, -- Debounced time for highlighting node (in ms)
      ...
      -- Optional: Rainbow parentheses for better visual distinction
      rainbow = {
        enable = false, -- Disabled since using dedicated rainbow-delimiters.nvim plugin
  ...
  -- Optional: Add textobjects plugin if not already included
  {
    ...
    config = function()
      ...
      if package.loaded["nvim-treesitter"] then
        require("nvim-treesitter.configs").reattach_module("textobjects")
      end
    end,
  },
  ...
  -- Treesitter Context
  {
    ...
    opts = {
      enable = true, -- Enable context for all supported languages
      max_lines = 0, -- Do not limit the number of lines for context (0 means no limit)
      multiline_threshold = 20, -- Show context when function spans more than 20 lines
    },
  },
  ...
  -- Optional: Rainbow delimiters (if not using built-in rainbow)
  {
